function construirParecer(nome, valor) {
    const opcoes = {
        notas: {
            ...
            "3": ["As notas do estudante estão dentro da média ou um pouco acima.", "O estudante apresenta notas que estão na média ou ligeiramente acima.", "As notas do estudante se situam na média ou apenas um pouco acima.", "As notas do estudante estão na média.", "O estudante tem notas que se encontram na média ou um pouco acima dela."],
            "4": ["As notas do estudante estão acima da média.", "O estudante apresenta notas superiores à média.", "As notas do estudante superam a média.", "O estudante tem notas que estão acima da média.", "As notas do estudante são acima da média."]
        },
        rendimento: {
            "1": ["No trimestre atual, o rendimento ficou abaixo do esperado.", "Atualmente o rendimento do estudante está abaixo do esperado.", "O desempenho ficou aquém do esperado.", "O estudante teve um rendimento inferior ao esperado.", "O rendimento está abaixo do nível esperado."],
